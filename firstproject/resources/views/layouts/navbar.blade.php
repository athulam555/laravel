        ...
        <nav id="navigation" class="navigation navigation-landscape">
            <div class="nav-header">
                <a class="nav-brand" href="#">
                    <img src="{{asset('/theme/assets/img/logo.png')}}" class="logo" alt="" />
                </a>
            ...
            <div class="nav-menus-wrapper" style="transition-property: none;">
                <ul class="nav-menu">
                    ...
                    <li class="active" :active="request()->is('products*')"><a href="{{ url('/products')}}" >Product<span class="submenu-indicator"></span></a>
                    </li>
